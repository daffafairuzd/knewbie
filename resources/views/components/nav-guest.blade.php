        ...
        <div class="hidden lg:flex items-center gap-5 ml-auto">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('register') }}"
                   class="rounded-full border border-gray-200 py-3 px-5 bg-white hover:border-blue-600 transition-all duration-300">
                    <span class="font-semibold">Sign Up</span>
                </a>
                <a href="{{ route('login') }}"
                   class="rounded-full py-3 px-5 bg-blue-600 hover:shadow-lg transition-all duration-300">
